; $Id: kcwi_proc_std.pro,v 1.4 2015/02/08 17:11:02 neill Exp $
...
pro kcwi_proc_std,ifil,display=display
	...
	; setup
	pre = 'KCWI_PROC_STD'
	version = repstr('$Revision: 1.4 $ $Date: 2015/02/08 17:11:02 $','$','')
	q=''
	;
	; check input file
	if file_test(ifil,/read) then begin
		readcol,ifil,w,fjy,comment='*',format='f,f',/si	; milli-Jy
	endif else begin
