; $Id: kcwi_prep.pro | Tue Mar 3 14:00:55 2015 -0800 | Don Neill  $
;
...
pro kcwi_prep,rawdir,reduceddir,calibdir,datadir, $
	...
	help=help
;
; a real different change
	;
	; setup
	pre = 'KCWI_PREP'
	version = repstr('$Revision: v0.1.3-beta-8-ge4c27b8 $ $Date: Tue Mar 3 14:00:55 2015 -0800 $','$','')
	startime=systime(1)
	q = ''	; for queries
	;
	; requested help?
